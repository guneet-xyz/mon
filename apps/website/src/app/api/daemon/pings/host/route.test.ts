...
function makeRequest(body: unknown, headers: Record<string, string>): Request {
  return new Request("http://localhost/api/daemon/pings/host", {
    method: "POST",
...
beforeEach(() => {
  ...
  await mock.module("@/lib/server/ingest/host", () => ({
    insertHostPing: async () => {
      insertCallCount++
...
describe("POST /api/daemon/pings/host", () => {
