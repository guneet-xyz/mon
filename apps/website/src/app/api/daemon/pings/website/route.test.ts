...
function makeRequest(body: unknown, headers: Record<string, string>): Request {
  return new Request("http://localhost/api/daemon/pings/website", {
    method: "POST",
...
beforeEach(() => {
  ...
  await mock.module("@/lib/server/ingest/website", () => ({
    insertWebsitePing: async () => {
      insertCallCount++
...
describe("POST /api/daemon/pings/website", () => {
