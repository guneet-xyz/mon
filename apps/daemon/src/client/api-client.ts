...
export class WebsiteApiClient {
  ...
  async getJobs() {
    let res: Response
    try {
      res = await this.fetch(`${this.baseUrl}/api/daemon/jobs`, {
